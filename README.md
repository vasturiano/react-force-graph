...
| <b>zoomToFit</b> | ([<i>ms</i>], [<i>px</i>]) | Automatically zooms/pans the canvas so that all of the nodes fit inside it. It takes two optional arguments: the first defines the duration of the transition (in ms) to animate the canvas motion (default: 0ms), and the second the amount of padding (in px) between the edge of the canvas and the outermost node (default: 10px). | :heavy_check_mark: | :heavy_check_mark: | | |
...
| <b>d3AlphaMin</b> | <i>number</i> | 0 | Sets the [simulation alpha min](https://github.com/vasturiano/d3-force-3d#simulation_alphaMin) parameter. | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| Method | Arguments | Description | 2D | 3D | VR | AR |
| --- | :--: | --- | :--: | :--: | :--: | :--: |
| <b>getGraphBbox</b> | () | Returns the current bounding box of all the nodes in the graph, formatted as `{ x: [<num>, <num>], y: [<num>, <num>], z: [<num>, <num>] }`. | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
