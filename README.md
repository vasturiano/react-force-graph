...
| <b>autoPauseRedraw</b> | <i>bool</i> | `true` | Getter/setter for performance optimization to automatically pause redrawing the 2D canvas at every frame whenever the simulation engine is halted. If you have custom dynamic objects that rely on a constant redraw of the canvas, it's recommended to switch this option off. | :heavy_check_mark: | | | |
| <b>minZoom</b> | <i>number</i> | 0.01 | Getter/setter for the 2D canvas lowest zoom out level permitted. | :heavy_check_mark: | | | |
| <b>maxZoom</b> | <i>number</i> | 1000 | Getter/setter for the 2D canvas highest zoom in level permitted. | :heavy_check_mark: | | | |
